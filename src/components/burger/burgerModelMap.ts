...
export const MODEL_MAP: Record<string, { url: string; y: number; scale: number }> = {
  ...
  'Queso': { url: require('../../../assets/images/Hamburguesa/Queso.glb') as string, y: 0.28, scale: 1.5 },
  'Lechuga': { url: require('../../../assets/images/Hamburguesa/lechuga.glb') as string, y: 0.40, scale: 3 },
